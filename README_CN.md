...
如果你 Fork 了知识库仓库，记得在 Pulsar 的配置文件中更新仓库名：

```bash
# 修改 GitHub 配置指向你的 fork
...
│   └── jobs.template.json      # 33 个 cron job 配置模板
│
├── memory/                     # 本地知识存储（.gitignored）
...
│   └── github-config-*.json    # GitHub 推送目标配置
│
├── docs/
