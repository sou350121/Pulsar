...
**選 Feedly AI**：如果你要零配置、有移動端、支持團隊協作、一百萬+信源——成熟穩定，開箱即用。  
**選 ResearchRabbit**：如果你在做學術文獻綜述——視覺化引用圖譜和 2.7億篇論文索引，系統性覆蓋很難被超越。  
**選 MineContext**：如果你想捕捉「你自己讀過的東西」——完全本地、保護隱私，不需要提前定義監控主題。  
**選 Pulsar**：如果你需要一個跑在服務器上、自動生成知識資產、故障自癒、並且月月變得更準的 pipeline。

| 維度 | Feedly AI | ResearchRabbit | MineContext | **Pulsar** |
|------|-----------|---------------|-------------|------------|
| **最擅長** | 團隊情報訂閱、移動端 | 學術引用圖譜 | 個人上下文捕捉 | 自主領域情報 pipeline |
| **部署** | ☁️ 僅 SaaS | ☁️ 僅 SaaS | ✅ 本地 / 開源 | ✅ 自托管 / 開源 |
| **費用** | $1,600–3,200 / 月 | 封閉定價 | 免費 | 免費 |
| **配置成本** | ✅ 零配置，開箱即用 | ✅ 零配置 | ✅ 桌面安裝 | ⚠️ 約 1 小時配置 |
| **信源覆蓋** | ✅ 100萬+策展信源 | ✅ 2.7億篇學術論文 | 你自己的文件/截圖 | arXiv · GitHub · RSS · 社區 |
| **信號評分** | ❌ | ❌ | ❌ | ✅ ⚡/🔧/📖/❌ LLM 前截斷 |
| **LLM 推理** | ⚠️ AI 摘要 | ❌ | ⚠️ 單次調用 | ✅ 三段式 pipeline |
| **自癒恢復** | ❌ | ❌ | ❌ | ✅ 7 條自動恢復路徑 |
| **信念校準** | ❌ | ❌ | ❌ | ✅ 19 條假設，月度更新 |
| **預測追蹤** | ❌ | ❌ | ❌ | ✅ 每兩週 ✅/❌ 歷史驗證 |
